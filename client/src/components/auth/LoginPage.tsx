...
export function LoginPage() {
  ...
  const handleOAuth = (provider: string) => {
    // Carry the page the user was trying to reach (e.g. /join/<invite>)
    ...
    <div style={styles.container}>
      <div style={styles.content}>
        ...
        <div style={styles.oauthSection}>
          ...
          <button style={styles.googleBtn} onClick={() => handleOAuth('google')}>
        ...
        <p style={styles.footer}>Atlas Bound · Your adventure awaits.</p>
      </div>
    </div>
  );
}
