...
| T4.3 | Pre-commit hooks (prettier + husky + lint-staged) + `.editorconfig` | ✅ | Done in PR TBD; staged TS/JS files run Prettier + ESLint, staged JSON/CSS run Prettier, and lint globs use cross-shell double quotes |
